...
<body>
        ...
        <div class="layui-row">
            <div class="layui-col-xs8">
                <div class="layui-col-xs6">
                    <a href="/">
                        <img src="/front/picture/logo_bjtydx.png" alt="">
                    </a>
                </div>
                <div class="layui-col-xs6">
                    <a href="/">
                        <img src="/front/picture/ittf_logo.png" alt="">
                    </a>
                </div>
            </div>
            ...
            <div class="layui-container list_main_conter_in">
                  <div class="match_all layui-row">
                       <div class="layui-col-xs3 img_man">
                            ...
                            <img src="/front/picture/a_.jpg" alt="" class="img_in">
                            <!-- echarts -->
                            <div class="echars_in">
                       ...
                       <div class="layui-col-xs3 img_man">
                            ...
                            <img src="/front/picture/b_.jpg" alt="" class="img_in">
                            <div class="echars_in">
  ...
  <footer class="footer">
   ...
   <script src="/front/js/echarts.simple.min.js"></script>
   <script src="/front/js/jquery.js"></script>
   <script src="/front/js/layui.all.js"></script>
